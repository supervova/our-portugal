...
class OurPortugalSite extends Timber\Site {
	...
	public function register_post_types() {
		$realty_labels = array(
			...
			'menu_name'     => __( 'Real Estate (Недвижимость)', 'our-portugal' ),
			'all_items'     => __( 'All properties (Все объявления)', 'our-portugal' ),
			'search_items'  => __( 'Search a Property (Искать недвижимость)', 'our-portugal' ),
			'add_new'       => __( 'Add (Добавить)', 'our-portugal' ),
			'add_new_item'  => __( 'Add property (Добавить объявление)', 'our-portugal' ),
